...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_6__["default"])('.num-input');
  var messages = {
    loading: 'Загрузка...',
...
var modals = function modals() {
  function bindModal(triggersSelector, modalSelector, closeSelector, dependentInputsSelectors) {
    ...
    if (dependentInputsSelectors) {
      if (Array.isArray(dependentInputsSelectors)) {
        dependentInputs = dependentInputsSelectors.map(function (item) {
    ...
    triggers.forEach(function (trigger) {
      trigger.addEventListener('click', function (e) {
        if (e.target && !dependentInputsSelectors || Object(_validation__WEBPACK_IMPORTED_MODULE_2__["default"])(dependentInputs)) {
          e.preventDefault();
          windows.forEach(function (item) {
            return item.style.display = 'none';
          });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', '.checkbox-type', false); // showModalByTime('.popup', 60000)
};
...
var timer = function timer(parentSelector, deadline) {
  ...
  var setClock = function setClock(selector, endTime) {
    ...
    var daysNode = timer.querySelector('#days');
    var hoursNode = timer.querySelector('#hours');
    var minutesNode = timer.querySelector('#minutes');
    var secondsNode = timer.querySelector('#seconds');
  ...
  setClock(parentSelector, deadline); // setInterval(() => {
  //     console.log('ss')
